...
let DentistSchema = new Schema({
  ...
  office_hours: { type: String, required: false, default: null, max: 5000 },
  doctor_names: { type: String, required: false, default: null, max: 5000 },
  practice_info: { type: String, required: false, default: null, max: 5000 },
  emr_info: { type: String, required: false, default: null, max: 5000 },
  theme_info: { type: String, required: false, default: null, max: 5000 },
  social_info: { type: String, required: false, default: null, max: 5000 },
  forms: { type: String, required: false, default: null, max: 5000 },
  users: { type: String, required: false, default: null, max: 5000 },
  scheduling_info: { type: String, required: false, default: null, max: 5000 },
  npi: { type: Number, required: false, default: 0 },
  access_token: { type: String, required: false, default: null },
  first_ready: { type: Boolean, required: false, default: false },
  billing_info: { type: Boolean, required: false, default: false },
  first_ready: { type: Boolean, required: false, default: false },
  init_payment: { type: Boolean, default: false },
  //package: { type: Schema.Types.ObjectId, ref: 'Package' },
  service_provider: { type: Schema.Types.ObjectId, ref: 'ServiceProvider' },
  package: { type: String, enum: ['PRO', 'LITE'], required: false },
  auth_type: { type: String, enum: ['FB', 'GOOGLE', 'DESKTOP'], required: false },
